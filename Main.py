...
def delete_task():  
    ...
    try:  
        ...
        messagebox.showinfo('Error', 'Please Select a Task for Deleting.')        
...
if __name__ == "__main__":  
    ...
    guiWindow.title("To-Do List By Muskan Gupta")  
    ...
    functions_frame = tk.Frame(guiWindow, bg = "#2F4F4F")  
    listbox_frame = tk.Frame(guiWindow, bg = "#2F4F4F")  
